...
unsigned short BrbGetTimeText(struct RTCtime_typ* pTime, plcstring* pText, unsigned long nTextSize, plcstring* pFormat) // NOLINT(readability-function-cognitive-complexity)
{
